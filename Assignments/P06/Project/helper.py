...
if __name__=='__main__':
    ...
    for c in 'theattackisatdawn':
        ...
        """
                ADFGX Example: 
                Message: a group of rattlesnakes is called a rhumba
                Key 1: shelby
                Key 2: cobra

                Blank Polybius Square:
                * i and j occupy the same spot
                ...
                Polybius with first key: 'shelby'
                ...
                *For example, the letter 'h' translates to 'AD'

                Message: a group of rattlesnakes is called a rhumba
                Temp String: DD FAGGGAXAGD GADX GGDDGXGXAGAFAAFXFFAFAA FDAA 
                             DFDDAGAGAFDG DD GGADXAFGAXDD
                ...
                *Read from left to right across the rows

                Final Message: GFDDAXGGGAADAGGDGDXGXXDGGAAAGFFXAFFFAAFAFADADAADDGGFGADAGDDGGADXFDAXD
         """